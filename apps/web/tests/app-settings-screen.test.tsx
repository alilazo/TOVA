...
vi.mock("@/components/settings/SettingsScreen", () => ({
  SettingsScreen: () => <section data-testid="settings-screen" />,
}))
...
describe("App Settings panel", () => {
  ...
  it("keeps settings available without a project", async () => {
    renderApp()
    await waitFor(() => {
